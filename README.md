...
| :-------------------------- | ------------------------------------------------------------ | ------- | ------------------------------------------------------------ |
| Math Word Problem           | [📖] , [🗂️](https://github.com/arkilpatel/SVAMP/tree/main/data/mawps-asdiv-a_svamp_without_questions), [🔗](https://github.com/arkilpatel/SVAMP), [📄](https://arxiv.org/pdf/2103.07191.pdf) | Math Equation | Generate an equation given a math word problem question that<br/>explains patterns in data (*Official*) |
